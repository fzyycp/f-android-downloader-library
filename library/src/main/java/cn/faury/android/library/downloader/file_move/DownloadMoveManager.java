...
import cn.faury.android.library.downloader.listener.OnMoveDownloadFileListener.MoveDownloadFileFailReason;
import cn.faury.android.library.downloader.listener.OnMoveDownloadFileListener.OnMoveDownloadFileFailReason;
...
public class DownloadMoveManager {
    ...
    private static final String TAG = DownloadMoveManager.class.getName();
    ...
    public void move(String url, final String newDirPath, final OnMoveDownloadFileListener onMoveDownloadFileListener) {
        ...
        if (!mDownloadTaskPauseable.isDownloading(url)) {
            ...
            Logger.d(TAG, TAG + ".move 下载任务已经暂停，可以直接移动，url:" + url);

            singleMoveInternal(url, newDirPath, onMoveDownloadFileListener);
        } else {

            Logger.d(TAG, TAG + ".move 需要先暂停下载任务后移动，url:" + url);
            ...
            mDownloadTaskPauseable.pause(url, new OnStopFileDownloadTaskListener() {
                ...
                public void onStopFileDownloadTaskSucceed(String url) {
                    ...
                    Logger.d(TAG, TAG + ".move 暂停下载任务成功，开始移动，url:" + finalUrl);
                ...
                public void onStopFileDownloadTaskFailed(String url, StopDownloadFileTaskFailReason failReason) {
                    ...
                    Logger.d(TAG, TAG + ".move 暂停下载任务失败，无法移动，url:" + finalUrl);
