...
import cn.faury.android.library.downloader.DownloadStatusConfiguration.Builder;
import cn.faury.android.library.downloader.base.Control;
import cn.faury.android.library.downloader.file_delete.DownloadDeleteManager;
import cn.faury.android.library.downloader.file_download.DownloadTaskManager;
import cn.faury.android.library.downloader.file_download.DownloadTaskManager.OnReleaseListener;
import cn.faury.android.library.downloader.file_move.DownloadMoveManager;
import cn.faury.android.library.downloader.file_rename.DownloadRenameManager;
...
import cn.faury.android.library.downloader.listener.OnRenameDownloadFileListener;
    ...
    private void checkInit() {
        if (!isInit()) {
            throw new IllegalStateException("Please init the file-downloader by using " + FileDownloader.class
                    .getName() + ".init(FileDownloadConfiguration) or " + FileDownloadManager.class
                    .getName() + ".init(FileDownloadConfiguration) if the version is below 0.2.0 !");
        }
    }
