package cn.faury.android.library.downloader.file_download.http_downloader;
...
import cn.faury.android.library.downloader.file_download.CloseConnectionTask;
import cn.faury.android.library.downloader.file_download.HttpConnectionHelper;
import cn.faury.android.library.downloader.file_download.HttpConnectionHelper.RequestParam;
import cn.faury.android.library.downloader.file_download.base.HttpFailReason;
...
public class HttpDownloader implements Download {
    ...
    public void download() throws HttpDownloadException {
        ...
        try {
            ...
            Logger.d(TAG, ".download 1、准备下载，重定向：" + redirectTimes + "次" + "，最大重定向次数：" + MAX_REDIRECT_TIMES +
                    "，url：" + url);
            ...
            Logger.d(TAG, ".download Response Headers:" + HttpConnectionHelper.getStringHeaders(conn
                    .getHeaderFields()));
            ...
            if (responseCode == HttpURLConnection.HTTP_OK || responseCode == HttpURLConnection.HTTP_PARTIAL) {
                ...
                Logger.d(TAG, ".download 2、得到服务器返回的资源contentLength：" + contentLength + "，传入的range：" + mRange
                        .toString() + "，url：" + url);
                ...
                // partial range, that means range of the data
                    ...
                    if (!TextUtils.isEmpty(mETag)) {
                        ...
                        Logger.d(TAG, ".download 3、得到服务器返回的资源eTag：" + eTag + "，传入的eTag：" + mETag + "，url：" + url);
                ...
                Logger.d(TAG, ".download 4、准备处理数据，获取服务器返回的资源长度为：" + contentLength + "，获取服务器返回的输入流长度为：" +
            ...
            Logger.d(TAG, ".download 5、Http文件下载【已结束】，是否有异常：" + hasException + "，url：" + url);
        }
